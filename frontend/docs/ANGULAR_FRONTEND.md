...
| **Interactive chart** | Chart.js + `chartjs-chart-financial` — **Candles** or **Line** toggle; horizontal price levels; event bar wick highlights (liquidity / entry / exit) in Candles mode |
