...
| `mt5ExportAvailable` | `true` when `GrokDevOrderRsiExport.ex5` JSON is fresh (default max age 30s; env `MT5_RSI_EXPORT_MAX_AGE`). Install: [python/mt5_scripts/README.md](../python/mt5_scripts/README.md) |
